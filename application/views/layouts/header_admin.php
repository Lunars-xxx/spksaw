...
<head>
  ...
  <title>Sistem Penunjang Keputusan Metode SAW</title>
  ...
  <link rel="shortcut icon" href="<?= base_url('assets/')?>img/ipj.png" type="image/x-icon">
  <link rel="icon" href="<?= base_url('assets/')?>img/ipj.png" type="image/x-icons">
...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('Login/home'); ?>">
  <div class="sidebar-brand-text">CV.INOVASI PRIANGAN JAYA</div>
</a>
...
<li class="nav-item <?php if($page=='Barang'){echo 'active';}?>">
